...
@section('content_header')
    ...
    <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active"><a href="{{ route('plans.profiles.available', $plan->id) }}" class="active">Perfis</a></li>
    </ol>

    <h1>Perfis disponiveis para o plano <strong>{{ $plan->name }} </strong>
